...
const String TXT_SNOWFALL_MM = "Opady śniegu (mm)";
const String TXT_SNOWFALL_IN = "Opady śniegu (in)";
const String TXT_PRECIPITATION_SOON = "Opady wkrótce";

//Sun
const String TXT_SUNRISE  = "Wschód";
const String TXT_SUNSET   = "Zachód";

//Moon
const String TXT_MOON_NEW             = "Nowiu";
const String TXT_MOON_WAXING_CRESCENT = "Wzrastający sierp";
const String TXT_MOON_FIRST_QUARTER   = "Pierwsza kwadra";
const String TXT_MOON_WAXING_GIBBOUS  = "Wzrastający garb";
const String TXT_MOON_FULL            = "Pełnia";
const String TXT_MOON_WANING_GIBBOUS  = "Malejący garb";
const String TXT_MOON_THIRD_QUARTER   = "Trzecia kwadra";
const String TXT_MOON_WANING_CRESCENT = "Malejący sierp";
...
//Wind
const String TXT_WIND_SPEED_DIRECTION = "Prędkość wiatru / Kierunek";
